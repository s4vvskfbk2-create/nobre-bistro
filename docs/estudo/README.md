...
|-----|----------|----------|
| [`01-cmv-e-ficha-tecnica.md`](./01-cmv-e-ficha-tecnica.md) | CMV Fundamentos (curso) + apresentação "CMV Ferramenta Aplicada" (Érika Guedes) + planilha dos Bastones di Cogumelos | **Conceitual / teórico** |
| [`02-tecnologias-gerenciais-3-abas.md`](./02-tecnologias-gerenciais-3-abas.md) | Livro "Tecnologias Gerenciais de Restaurantes" (Marcelo Trad Fonseca), compilado em MD + JSON | **Especificação prática (3 abas, fórmulas, benchmarks)** |
...
- **Simulador de precificação** por meta de CMV (ex.: 25%–45%, como na planilha
  dos bastones) e por benchmark de segmento.
